...
Raised against tonearm in the marketplace security review of 2026-09-14,
where it blocked listing. Galley ships the same way and is already listed,
so the exposure here was live rather than pending. Galley already had a
`CONTRIBUTING.md` covering how to build and test, so the layer map and trap
catalogue became `ARCHITECTURE.md` rather than being merged into it. This
test is what stops the old name coming back, under any of the spellings that
